...
export default function Dashboard() {
  const content = (
    <main className="flex items-center justify-center px-4 min-h-screen bg-lightgray">
      <div
        className={`${
          ...
          <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <WobbleCard containerClassName="w-[180px] h-[160px] bg-white cursor-pointer">
                <Link
                  href="/create-request"
                  className="w-full h-full flex items-center justify-center text-[#7B4019] font-poppins text-3xl"
                >
                  Create request
                </Link>
              </WobbleCard>
              ...
              <WobbleCard containerClassName="w-[180px] h-[255px] bg-[#FFEEA9] cursor-pointer">
                <Link
                  href="/status"
                  className="w-full h-full flex items-center justify-center text-[#7B4019] font-poppins text-6xl rotate-90"
                >
                  Status
                </Link>
              </WobbleCard>
            ...
            <div className="flex flex-col gap-2">
              ...
              <WobbleCard containerClassName="w-[260px] h-[70px] bg-[#FFBF78] cursor-pointer">
                <Link
                  href="/signin"
                  className="flex items-center justify-center gap-2 w-full h-full text-[#7B4019] font-poppins text-2xl"
                >
                  Log out
                  <svg
              ...
              <WobbleCard containerClassName="w-[260px] h-[350px] bg-[#FFEEA9] cursor-pointer">
                <Link
                  href="/requests"
                  className="w-full h-full py-4 flex flex-col items-center justify-start text-[#7B4019] font-poppins text-3xl"
                >
                  <span className="mb-6">Live Requests</span>
                  <div className="bg-white px-20 py-20 rounded-xl shadow flex items-center gap-3 text-lg font-semibold relative">
                    <span className="text-[#7B4019] text-5xl">39</span>
  ...
  // 🔁 Conditionally wrap with BackgroundLines
